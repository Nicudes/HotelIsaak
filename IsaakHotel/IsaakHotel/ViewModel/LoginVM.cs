...
namespace IsaakHotel.ViewModel
{
    class LoginVM : INotifyPropertyChanged
    {
        ...
        {
            get { return name; }
            set { name = value; OnPropertyChanged("Name"); OnPropertyChanged("CanRegister"); }
        }
        ...
        public string ConfirmPassword
        {
            ...
            set { confirmPassword = value; OnPropertyChanged("ConfirmPassword"); OnPropertyChanged("CanRegister"); }
        }
